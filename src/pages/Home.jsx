...
function Hero() {
  ...
  {/* Donate Button */}
  <a
    href="/donate"   // change later to Stripe / PayPal link
    className="inline-flex items-center justify-center px-7 py-3 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition shadow-lg"
