...
const TRAINING_VIDEOS = [
  ...
  {
    id: 15,
    title: "Leg Extension | Build Stronger Quads",
    type: "video",
    category: "Lower Body Strength",
    focus: "Quadriceps",
    difficulty: "Beginner",
    duration: "0:23",
    description:
      "A leg-extension exercise focused on strengthening the quadriceps with controlled movement and proper lower-body training technique.",
    url: "https://www.youtube.com/watch?v=ZC9TXO5GEcQ&list=PLKHETpXCwfvs&index=2",
  },

  {
    id: 16,
    title: "Seated Leg Curl | Build Stronger Hamstrings",
    type: "video",
    category: "Lower Body Strength",
    focus: "Hamstrings",
    difficulty: "Beginner",
    duration: "0:29",
    description:
      "A seated leg-curl exercise designed to strengthen the hamstrings while emphasizing controlled movement and proper form.",
    url: "https://www.youtube.com/watch?v=QtyQ-57n-EU&list=PLKHETpXCwfvs&index=3",
  },
  ...
  {
    id: 17,
    title: "Treadmill Workout | Build Cardio & Endurance",
    type: "short",
    category: "Cardio & Conditioning",
    focus: "Cardio",
    difficulty: "Beginner",
    duration: "0:17",
    description:
      "A quick treadmill workout focused on building cardiovascular endurance, improving stamina, and supporting overall fitness.",
    url: "https://www.youtube.com/watch?v=ZcwN3XJh6GY&list=PLKHETpXCwfvs&index=1",
  },
];
