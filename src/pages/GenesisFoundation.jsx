        ...
        <div className="mx-auto max-w-7xl px-4 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-prose">
              We partner with GFFT to redistribute donated tennis gear to underserved children and connect students to
              sports access, mentorship, and structured programs.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              >
                How to help <ArrowRight className="h-4 w-4" />
              </a>
              <Link
                to="/contact"
            ...
            <Card className="rounded-3xl shadow-lg">
              <CardContent className="p-8">
                <div className="flex items-center gap-3">
                  ...
                  <p className="font-semibold text-slate-800">Tennis for Good</p>
                </div>
          ...
          <Card className="rounded-2xl">
            <CardContent>
              ...
              <p className="mt-3 text-slate-600 leading-relaxed">
                Donated tennis gear is redistributed to underserved children through GFFT, helping students access
                sports, mentorship, and structured programs.
              </p>
              <p className="mt-4 text-sm text-slate-500">
                Add your “tennis gear donation flyer” link here when ready.
              </p>
            </CardContent>
          </Card>
